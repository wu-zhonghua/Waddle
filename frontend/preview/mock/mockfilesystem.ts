...
function createMockFilesystemEntries(): MockFsEntryInput[] {
    const entries: MockFsEntryInput[] = [
        ...
        { path: `${MockHomePath}/waddle`, isdir: true },
        { path: `${MockHomePath}/waddle/docs`, isdir: true },
        { path: `${MockHomePath}/waddle/images`, isdir: true },
        { path: `${MockHomePath}/.config`, isdir: true },
        makeMockFsInput(
            `${MockHomePath}/.bashrc`,
            `export PATH="$HOME/bin:$PATH"\nalias gs="git status -sb"\nexport WADDLE_THEME="midnight"\n`,
            "text/plain"
        ),
        ...
        makeMockFsInput(`${MockHomePath}/Downloads/waddle-nightly.dmg`),
        ...
        makeMockFsInput(
            `${MockHomePath}/waddle/README.md`,
            `# Mock Waddle Repo\n\nThis fake repo exists only in the preview environment.\nIt gives file previews something realistic to browse.\n`,
            "text/markdown"
        ),
        makeMockFsInput(`${MockHomePath}/waddle/package.json`),
        makeMockFsInput(`${MockHomePath}/waddle/tsconfig.json`),
        makeMockFsInput(`${MockHomePath}/waddle/Taskfile.yml`),
        makeMockFsInput(`${MockHomePath}/waddle/preview-model.tsx`),
        makeMockFsInput(`${MockHomePath}/waddle/mockwaveenv.ts`),
        makeMockFsInput(`${MockHomePath}/waddle/vite.config.ts`),
        makeMockFsInput(`${MockHomePath}/waddle/CHANGELOG.md`),
        makeMockFsInput(
            `${MockHomePath}/waddle/docs/preview-notes.md`,
        ...
        makeMockFsInput(`${MockHomePath}/waddle/docs/filesystem-rpc.md`),
        makeMockFsInput(`${MockHomePath}/waddle/docs/test-plan.md`),
        makeMockFsInput(`${MockHomePath}/waddle/docs/connections.md`),
        makeMockFsInput(`${MockHomePath}/waddle/docs/preview-gallery.md`),
        makeMockFsInput(`${MockHomePath}/waddle/docs/release-notes.md`),
        makeMockFsInput(`${MockHomePath}/waddle/images/waddle-logo.png`, TinyPngBytes, "image/png"),
        makeMockFsInput(`${MockHomePath}/waddle/images/hero.png`),
        makeMockFsInput(`${MockHomePath}/waddle/images/avatar.jpg`),
        makeMockFsInput(`${MockHomePath}/waddle/images/icon-16.png`),
        makeMockFsInput(`${MockHomePath}/waddle/images/icon-32.png`),
        makeMockFsInput(`${MockHomePath}/waddle/images/splash.jpg`),
        makeMockFsInput(
