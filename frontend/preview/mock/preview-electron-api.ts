...
const previewElectronApi: ElectronApi = {
    ...
    showSaveFileDialog: (_defaultPath: string) => Promise.resolve(null),
    writeLocalFileChunk: (_data: LocalFileChunkData) => Promise.resolve(),
    deleteLocalPath: (_path: string) => Promise.resolve(),
    ...
    onReinjectKey: (_callback: (waveEvent: WaddleKeyboardEvent) => void) => {},
    ...
    onWaddleInit: (_callback: (initOpts: WaddleInitOpts) => void) => {},
    ...
    setWaddleAIOpen: (_isOpen: boolean) => {},
    closeBuilderWindow: () => {},
