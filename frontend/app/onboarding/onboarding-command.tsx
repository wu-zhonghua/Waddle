...
import waddleLogo from "/logos/waddle-logo.png";
...
export const ViewLogoCommand = ({ onComplete }: { onComplete?: () => void }) => {
    return (
        <FakeCommand command="wsh view public/waddle-logo.png" onComplete={onComplete}>
            <FakeBlock icon="image" name="waddle-logo.png" imgsrc={waddleLogo} />
        </FakeCommand>
    );
};
