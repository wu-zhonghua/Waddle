...
Waddle는 macOS, Linux, Windows에서 동작하는 오픈소스 AI 통합 터미널입니다. 어떤 AI 모델과도 함께 사용할 수 있습니다. OpenAI, Claude, Gemini는 API 키를 직접 연결해 사용할 수 있고, Ollama 및 LM Studio를 통해 로컬 모델도 실행할 수 있습니다. 계정 생성은 필요하지 않습니다.

또한 Waddle는 네트워크 중단이나 재시작 이후에도 유지되는 내구성 있는 SSH 세션을 지원하며, 자동 재연결 기능을 제공합니다. 내장 그래픽 에디터로 원격 파일을 편집하고, 터미널을 벗어나지 않고도 파일을 인라인으로 미리볼 수 있습니다.

![Waddle Screenshot](./assets/waddle-screenshot.webp)

## 주요 기능

- Waddle AI - 터미널 출력과 위젯을 이해하고 파일 작업까지 수행할 수 있는 컨텍스트 인지형 터미널 어시스턴트
- 내구성 있는 SSH 세션 - 연결 끊김, 네트워크 변경, Waddle 재시작 상황에서도 자동 재연결로 세션 유지
...
Waddle AI는 워크스페이스 맥락을 이해하는 터미널 어시스턴트입니다.
...
자세한 내용은 [Waddle AI 문서](https://docs.waddle.dev/waveai)와 [Waddle AI Modes 문서](https://docs.waddle.dev/waveai-modes)를 참고하세요.

## 설치

Waddle은 macOS, Linux, Windows에서 동작합니다.

플랫폼별 설치 방법은 [여기](https://docs.waddle.dev/gettingstarted)에서 확인할 수 있습니다.

직접 다운로드하여 설치하려면 [www.waddle.dev/download](https://www.waddle.dev/download)을 이용하세요.

### 최소 요구 사항

Waddle은 다음 플랫폼에서 실행됩니다.
...
Waddle는 계속 발전하고 있습니다. 로드맵은 릴리스 목표에 맞춰 지속적으로 업데이트됩니다. [여기](./ROADMAP.md)에서 확인하세요.

향후 릴리스 방향에 의견을 주고 싶다면 [Discord](https://discord.gg/XfvZ334gwU)에 참여하거나 [Feature Request](https://github.com/waddledev/waddle/issues/new/choose)를 등록해 주세요.

## 링크

- 홈페이지 &mdash; https://www.waddle.dev
- 다운로드 페이지 &mdash; https://www.waddle.dev/download
- 문서 &mdash; https://docs.waddle.dev
- X &mdash; https://x.com/waddledev
- Discord 커뮤니티 &mdash; https://discord.gg/XfvZ334gwU

## 소스에서 빌드

[Building Waddle](BUILD.md)을 참고하세요.

## 기여하기

Waddle는 GitHub Issues를 이슈 추적에 사용합니다.
...
Waddle은 Apache-2.0 라이선스를 따릅니다. 의존성 정보는 [여기](./ACKNOWLEDGEMENTS.md)에서 확인할 수 있습니다.
