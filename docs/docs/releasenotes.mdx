...
Waddle v0.14.5 introduces a new Process Viewer widget, Quake Mode for global hotkey, and several quality-of-life improvements.
...
- **Quake Mode** - The global hotkey (`app:globalhotkey`) now toggles a Waddle window visible and invisible
...
- **Drag & Drop Files into Terminal** - Drag files from Finder (macOS) or your file manager into a terminal block to paste their quoted path ([#746](https://github.com/waddledev/waddle/issues/746))
...
Waddle v0.14.4 introduces vertical tabs, upgrades to xterm.js v6, and includes a collection of bug fixes and internal improvements.
...
- **Config Errors Moved** - Config errors removed from the tab bar and moved to Settings / WaddleConfig view for less clutter
- **Warn on Unsaved Changes** - WaddleConfig view now warns before discarding unsaved changes
...
- **macOS First Click** - Improved first-click handling on macOS (cancel the click but properly set block/WaddleAI focus)
...
Waddle v0.14.2 adds block/tab badges, directory preview improvements, and assorted bug fixes.
...
- Working on anthropic-messages Waddle AI backend (for native Claude integration)
...
Waddle v0.14.1 fixes several high-impact terminal bugs (Claude Code scrolling, IME input) and adds new config options: focus-follows-cursor, cursor style customization, workspace-scoped widgets, and vim-style block navigation.
...
Waddle v0.14 introduces Durable Sessions for SSH connections, allowing your remote terminal sessions to survive connection interruptions, network changes, and Waddle restarts. This release also includes major improvements to connection monitoring, RPC infrastructure with flow control, and expanded terminal capabilities.

**Durable Sessions (Remote SSH Only):**
- **Survive Interruptions** - SSH terminal sessions persist through network changes, computer sleep, and Waddle restarts, automatically reconnecting when the connection is restored
- **Session Protection** - Shell state, running programs, and terminal history are maintained even when Waddle is closed or disconnected
...
- See the new [Durable Sessions documentation](https://docs.waddle.dev/durable-sessions) for setup and usage
...
- **AI Panel Scroll Latch** - Improved auto-scrolling behavior in Waddle AI panel
...
- **Removed S3 and WaddleFile** - S3 filesystem and wavefile implementations removed to prevent large/recursive file transfer issues and simplify codebase

**Other Changes:**
- **Confirm on Quit** - Added confirmation dialog when closing Waddle with active sessions
...
- [bugfix] Fixed duplicated Waddle AI system prompt for some providers
...
**Windows Improvements and Waddle AI Enhancements**

This release focuses on significant Windows platform improvements, Waddle AI visual updates, and better flexibility for local AI usage.
...
- **Git Bash Auto-Detection** - Waddle now automatically detects Git Bash installations and adds them to the connection dropdown for easy access
- **SSH Agent Fallback** - Improved SSH agent support with automatic fallback to `\\.\pipe\openssh-ssh-agent` on Windows
- **Updated Focus Keybinding** - Waddle AI focus key changed to Alt:0 on Windows for better consistency
...
- **BYOK Without Telemetry** - Waddle AI now works with bring-your-own-key and local models without requiring telemetry to be enabled
...
**Waddle v0.13 Brings Local AI Support, BYOK, and Unified Configuration**

Waddle v0.13 is a major release that opens up Waddle AI to local models, third-party providers, and bring-your-own-key (BYOK) configurations. This release also includes a completely redesigned configuration system and several terminal improvements.

**Local AI & BYOK Support:**
- **OpenAI-Compatible API** - Waddle now supports any provider or local server using the `/v1/chat/completions` endpoint, enabling use of Ollama, LM Studio, vLLM, OpenRouter, and countless other local and hosted models
...
- See the new [Waddle AI Modes documentation](https://docs.waddle.dev/waveai-modes) for configuration examples and setup guides
...
- **Integrated Secrets Management** - Access Waddle's secret store directly from the config widget for secure credential management
...
- **SSH Password Management** - Store SSH connection passwords in Waddle's secret store to avoid re-typing credentials
...
- Minor Waddle AI improvements (image handling, scrolling, focus)
- Package updates and dependency upgrades
- WIP: WaddleApps builder framework (not yet released)

### v0.12.3 &mdash; Nov 17, 2025

Patch release with Waddle AI model upgrade, new secret management features, and improved terminal input handling.
...
- WIP: New WaddleApps builder framework (not yet released)
- Package updates and dependency bumps

### v0.12.2 &mdash; Nov 4, 2025

Waddle v0.12.2 adds file editing ability to Waddle AI. Before approving a file edit you can easily see a diff (rendered in the Monaco Editor diff viewer), and after approving an edit you can easily roll back the change using a "Revert File" button.

**Waddle AI Updates:**
- **File Write Tool** - Waddle AI can now create and modify files with your approval
...
- **Drag & Drop Files** - Drag files from the preview viewer directly to Waddle AI
...
Patch release focused on shell integration improvements and Waddle AI enhancements. This release fixes syntax highlighting in the code editor and adds significant shell context tracking capabilities.

**Shell Integration & Context:**
- **OSC 7 Support** - Added OSC 7 (current working directory) support across bash, zsh, fish, and pwsh shells. Waddle now automatically tracks and restores your current directory across restarts for both local and remote terminals.
- **Shell Context Tracking** - Implemented shell integration for bash, zsh, and fish shells. Waddle now tracks when your shell is ready to receive commands, the last command executed, and exit codes. This enhanced context enables better terminal management and lays the groundwork for Waddle AI to write and execute commands intelligently.

**Waddle AI Improvements:**
- Display reasoning summaries in the UI while waiting for AI responses
- Added enhanced terminal context - Waddle AI now has access to shell state including current directory, command history, and exit codes
...
**Other Changes:**
- Mobile user agent emulation support for web widgets [#2442](https://github.com/waddledev/waddle/issues/2442)
- [bugfix] Fixed padding for header buttons in code editor (Tailwind regression)
- [bugfix] Restored syntax highlighting in code editor preview blocks [#2427](https://github.com/waddledev/waddle/issues/2427)
- Package updates and dependency bumps

### v0.12.0 &mdash; Oct 16, 2025

**Waddle v0.12 Has Arrived with Waddle AI (beta)!**

Waddle v0.12.0 introduces a completely redesigned AI experience powered by OpenAI GPT-5. This represents a major upgrade and modernization over Waddle's previous AI integration, bringing multi-modal support, advanced tool integration, and an intuitive new interface. The main AI PR alone included 128 commits and added 13,000+ lines of code.

**Waddle AI Features:**
- **New Slide-Out Chat Panel** - Access Waddle AI via hotkeys (Cmd-Shift-A or Ctrl-Shift-0) from the left side of your screen
...
- **Command-Line Integration** - Send files and command output directly to Waddle AI using `wsh ai`
- **Smart Context Switching** - Enable Waddle AI to see into your widgets and file system
- **Built-in Tools:**
...
Waddle AI is in active beta with included AI credits while we refine the experience. BYOK (Bring Your Own Key) will be available once we've stabilized core features and gathered feedback on what works best. Share your feedback in our [Discord](https://discord.gg/XfvZ334gwU).

For more information and upcoming features, visit our [Waddle AI documentation](https://docs.waddle.dev/waveai).

**Other Improvements:**
- New onboarding flow showcasing block magnification, Waddle AI, and wsh view/edit capabilities
...
* WIP: Integrating new Tsunami widget framework to make writing and running Waddle widgets easier
...
Another housekeeping release to modernize Waddle and bring it more up to date.

* Waddle AI Cloud Proxy now uses gpt-5-mini (upgraded from gpt-4o-mini)
* Fixed JWT issue with running "Waddle Apps" from widgets
* Added an "$ENV:envvar:fallback" syntax to the config files to allow Waddle's config to pick up values from the environment (mostly to allow moving secrets out of the config files)
...
* Removed some Waddle v7 aware upgrades and old code paths
...
* Update AI Libraries, GPT-5 now supported in WaddleAI
...
Waddle v0.11.1 adds a lot of new functionality over v0.11.0 (it could have almost been a v0.12)!
...
- **Drag and Drop Files and Directories** between Waddle directory views. This works across machines and between remote machines and S3 conections.
...
Waddle v0.11.0 includes a major rewrite of our connections infrastructure, with changes to both our backend and remote file protocol systems, alongside numerous features, bug fixes, and stability improvements.
...
For day-to-day use, we've added search functionality across both terminal and web blocks, along with a terminal multi-input feature for simultaneous input to all terminals within a tab. We've also added support for Google Gemini to Waddle AI, expanding our suite of AI integrations.
...
- **Waddle AI now supports Google Gemini**
...
- [bugfix] Windows URLs now work properly for Waddle background images
...
- Global hotkey support [docs](https://docs.waddle.dev/config#customizable-systemwide-global-hotkey)
- Added configuration to override the font size for markdown, AI-chat, and preview editor [docs](https://docs.waddle.dev/config)
...
Waddle v0.10.0 introduces workspaces, making it easier to manage multiple work environments. We've added powerful new command execution capabilities with `wsh run`, allowing you to launch and control commands in dedicated blocks. This release also brings significant improvements to SSH with a new connections configuration system for managing your remote environments.

- **Workspaces**: Organize your work into separate environments, each with their own tabs, layouts, and settings
- **Command Blocks**: New `wsh run` command for launching terminal commands in dedicated blocks, with support for magnification, auto-closing, and execution control ([docs](https://docs.waddle.dev/wsh-reference#run))
- **Connections**: New configuration system for managing SSH connections, with support for wsh-free operation, per-connection themes, and more ([docs](https://docs.waddle.dev/connections))
...
- Added Perplexity API integration ([docs](https://docs.waddle.dev/faq#perplexity))
- `wsh setbg` command for background handling ([docs](https://docs.waddle.dev/wsh-reference#setbg))
- Switched from Less to SCSS for styling
- [bugfix] Fixed tab flickering issues during tab switches
- [bugfix] Corrected WaddleAI text area resize behavior
...
- Lots of new documentation, including new pages for [Getting Started](https://docs.waddle.dev/gettingstarted), [AI Presets](https://docs.waddle.dev/ai-presets), and [wsh overview](https://docs.waddle.dev/wsh).
- Other bug fixes, performance improvements, and dependency updates

### v0.9.3 &mdash; Nov 20, 2024

New minor release that introduces Waddle's connected computing extensions. We've introduced new `wsh` commands that allow you to store variables and files, and access them across terminal sessions (on both local and remote machines).

- `wsh setvar/getvar` to get and set variables -- [Docs](https://docs.waddle.dev/wsh-reference#getvarsetvar)
- `wsh file` operations (cat, write, append, rm, info, cp, and ls) -- [Docs](https://docs.waddle.dev/wsh-reference#file)
...
- Editing the AI presets file from the Waddle AI block now brings up an ephemeral editor
...
- [bugfix] Fix terminal theming when applying global defaults [#1287](https://github.com/waddledev/waddle/issues/1287)
...
New minor release with bug fixes and new features! Fixed the bug around making Waddle fullscreen (also affecting certain window managers like Hyprland). We've also put a lot of work into the doc site (https://docs.waddle.dev), including documenting how [Widgets](./widgets) and Presets work!

- Updated documentation
- Waddle AI now supports the Anthropic API! Checkout the [FAQ](./faq) for how to use the Claude models with Waddle AI.
...
- CLI applications that need microphone, camera, or location access will now work on MacOS. You'll see a security popup in Waddle to allow/deny [#1086](https://github.com/waddledev/waddle/issues/1086)
...
- There is a new setting in the editor to enable/disable word wrapping [#1038](https://github.com/waddledev/waddle/issues/1038)
- Ctrl-S will now save files in codeedit [#1081](https://github.com/waddledev/waddle/issues/1081)
- [#1020](https://github.com/waddledev/waddle/issues/1020) there is now a preset config option to change the active border color in tab themes
- [bugfix] Multiple fixes for [#1167](https://github.com/waddledev/waddle/issues/1167) to try to address tab loss while updating
...
- [bugfix] [#1175](https://github.com/waddledev/waddle/issues/1175) can now edit .awk files
- [bugfix] [#1066](https://github.com/waddledev/waddle/issues/1066) applying a default theme now updates the background appropriately without a refresh

### v0.9.0 &mdash; Oct 28, 2024

New major Waddle release! Waddle tabs are now cached. Tab switching performance is
now much faster and webview state, editor state, and scroll positions are now persisted
across tab changes. We also have native WSL2 support. You can create native Waddle connections
...
Lots of other smaller changes and bug fixes. See full list of PRs at https://github.com/waddledev/waddle/releases/tag/v0.9.0

### v0.8.13 &mdash; Oct 24, 2024

- Waddle is now available as a Snap for Linux users! You can find it [in the Snap Store](https://snapcraft.io/waddle).
- Waddle is now available via the Windows Package Manager! You can install it via `winget install CommandLine.Waddle`
...
- added support for Azure AI [See FAQ](https://docs.waddle.dev/faq#how-can-i-connect-to-azure-ai)
...
- New "help" view -- uses an embedded version of our doc site -- https://docs.waddle.dev
...
- New startup model for legacy users given them the option to download the WaddleLegacy
- Use WADDLE_HOME for the home directory consistently
...
Release Artificats and source code diffs can be found on (Github)[https://github.com/waddledev/waddle].
