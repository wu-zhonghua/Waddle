...
Here's the set of default keybindings available in Waddle. It is split into sections.
...
| <Kbd k="Cmd:Shift:a"/>                                       | Toggle WaddleAI panel visibility                                                                                                                       |
...
| <Kbd k="Ctrl:Shift:0"/>                                      | Focus WaddleAI input                                                                                                                                   |
...
## WaddleAI Keybindings

| Key                                     | Function              |
| --------------------------------------- | --------------------- |
| <Kbd k="Cmd:Shift:a"/>                  | Toggle WaddleAI panel |
| <Kbd k="Ctrl:Shift:0" windows="Alt:0"/> | Focus WaddleAI input  |
...
| <Kbd k="Cmd:Home"/>                     | Scroll to top             |
| <Kbd k="Cmd:End"/>                      | Scroll to bottom          |
| <Kbd k="Cmd:ArrowLeft"/>                | Move to beginning of line |
| <Kbd k="Cmd:ArrowRight"/>               | Move to end of line       |
...
Waddle allows setting a custom global hotkey to focus your most recent window from anywhere in your computer. For more information on this, see [the config docs](./config#customizable-systemwide-global-hotkey).
