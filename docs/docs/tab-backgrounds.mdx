...
Waddle's background system harnesses the full power of CSS backgrounds, letting you create rich visual effects through the "background" attribute. You can apply solid colors, gradients (both linear and radial), images, and even blend multiple elements together.

## Managing Backgrounds

Custom backgrounds are stored in `~/.config/waddle/backgrounds.json`.
...
To see how Waddle's built-in backgrounds are defined, check out the [default backgrounds.json file](https://github.com/waddledev/waddle/blob/main/pkg/wconfig/defaultconfig/backgrounds.json).
