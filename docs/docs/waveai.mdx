...
Waddle AI supports using your own AI models and API keys:
...
**Default Waddle AI Service:**
- Messages are proxied through the Waddle Cloud AI service (powered by OpenAI's APIs). Please refer to OpenAI's privacy policy for details on how they handle your data.
- Waddle does not store your chats, attachments, or use them for training
...
Waddle AI is in active beta with included AI credits while we refine the experience. Share feedback in our [Discord](https://discord.gg/XfvZ334gwU).
