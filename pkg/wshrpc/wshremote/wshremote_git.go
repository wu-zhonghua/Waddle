...
func (impl *ServerImpl) GitStatusCommand(ctx context.Context, data wshrpc.CommandGitStatusData) (*wshrpc.GitStatusData, error) {
...
func (impl *ServerImpl) GitDiffCommand(ctx context.Context, data wshrpc.CommandGitDiffData) (*wshrpc.CommandGitDiffRtnData, error) {
...
func (impl *ServerImpl) GitFileDiffCommand(ctx context.Context, data wshrpc.CommandGitFileDiffData) (*wshrpc.CommandGitFileDiffRtnData, error) {
...
func (impl *ServerImpl) GitReviewDiffCommand(ctx context.Context, data wshrpc.CommandGitReviewDiffData) (*wshrpc.CommandGitReviewDiffRtnData, error) {
...
func (impl *ServerImpl) GitUnstageCommand(ctx context.Context, data wshrpc.CommandGitStageData) error {
	return gitops.Unstage(ctx, data.Cwd, data.Paths)
}

func (impl *ServerImpl) GitCommitCommand(ctx context.Context, data wshrpc.CommandGitCommitData) (*wshrpc.CommandGitCommitRtnData, error) {
